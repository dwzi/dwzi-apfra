...
(function($){
    ...
    $.fn.serializelist = function() {
        ...
        if (serialStr.length > 0) serialStr = serialStr.slice(0,-1);
        return(serialStr);
    };
	  ...
	  $.fn.fixedHeader = function (options) {
	   ...
	   return this.each( function() {
	    ...
	    function processScroll() {
	      ...
	      else if (scrollTop <= headTop+44 && isFixed) { isFixed = 0; }
	    ...
	    // TODO error on resize; recreate ww!
	    var ww = [];
	  ...
	  $(document).on('click', '.collapsible .panel-heading span.clickable', function(e){
		    var $this = $(this);
